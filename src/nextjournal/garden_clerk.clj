...
(defn serve!
  "Serve dynamic clerk notebooks on application.garden.
  Takes the same options as `nextjournal.clerk/serve!`"
  [opts]
...
(defn serve-static!
  "Build clerk notebooks and serve the resulting html on application.garden.
  Takes the same options as `nextjournal.clerk/build!`"
  [opts]
